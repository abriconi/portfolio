...
const education: Education[] = [
  {
    ...
    date: "2005-2010",
    brief:
      "I hold a degree in Program Management of Foreign Economic Activity from Kryvyi Rih Technical University, providing me with a strong foundation in international business and trade.",
    degree: "Specialist",
  },
  {
    ...
    date: "2019",
    brief:
      "Passed Agile courses and obtained certification, studying project management methodologies, familiarizing with Scrum team roles, learning to correctly assess task difficulty and understanding Scrum ceremonies and their purposes.",
  ...
  },
  {
    ...
    date: "2023",
    brief:
      "Completed an in-depth TypeScript course, gaining comprehensive knowledge of TypeScript's advanced features, type system, and integration with modern JavaScript frameworks. Enhanced ability to develop robust and maintainable codebases.",
    degree: "",
  },
];
...
const experience: Experience[] = [
  {
    ...
    date: "2011 - 2015",
    brief:
      "Built long-term relationships with key clients, searched for new clients, presented and sold products, managed client expectations, and resolved complaints.",
  ...
  },
  {
    ...
    date: "2019 - 2020",
    brief:
      "Increased the company's net profit by attracting new clients and recontacting old customers, recruiting new IT specialists to boost productivity, initiating and implementing an IT-specialist training program, analyzing and regulating company expenses, and calculating compensation and bonuses.",
...
const certificates: Certificate[] = [
  {
    ...
    url: "/img/agile-certificate-min.jpg",
  },
  {
    ...
    url: "/img/js-certificate-min.jpg",
  },
  {
    ...
    date: "Sep 2022",
    skills: [Tools.ts],
    url: "/img/ts-certificate-min.jpg",
  },
  {
